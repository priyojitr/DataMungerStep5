...
public class Filter {
	...
	public boolean evaluateExpression(Restriction restriction, String fieldValue, String dataType) {
		if(restriction.getCondition().equals("="))
			...
			return isNotEqualTo(fieldValue, restriction.getPropertyValue(), dataType);
	...
	private boolean isEqualTo(String s1, String s2, String dataType) {
	...
	private boolean isNotEqualTo(String s1, String s2, String dataType) {
		return !isEqualTo(s1, s2, dataType);
	}
	...
	private boolean isGreaterThanOrEqualTo(String s1, String s2, String dataType) {
		return isEqualTo(s1, s2, dataType)|isGreaterThan(s1, s2, dataType);
	}
	...
	private boolean isLessThanOrEqualTo(String s1, String s2, String dataType) {
		return isEqualTo(s1, s2, dataType)|isLessThan(s1, s2, dataType);
	}
}
